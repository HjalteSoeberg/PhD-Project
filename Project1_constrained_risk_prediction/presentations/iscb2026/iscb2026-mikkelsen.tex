...
\label{sec:org707f556}

\begin{frame}[label={sec:org58ead91},fragile]{Competing risks risk prediction}
\begin{align*}
...
\begin{frame}[label={sec:orge61dbb4}]{Motivation}
...
\begin{frame}[label={sec:org5a2eb6c}]{Setting: competing risks}
...
\begin{frame}[label={sec:org7dc4feb}]{The idea: fit both risks to the prediction horizon}
...
\label{sec:org3392ce0}

\begin{frame}[label={sec:org4899b41}]{Focus of this talk: a single model, not prediction strategy}
\begin{center}
...
\begin{frame}[label={sec:org3265319}]{The Cox-exponential model}
...
\begin{frame}[label={sec:org6ef71ff}]{Brier score estimation}
...
\begin{frame}[label={sec:org45f082e}]{Why estimate like this?}
...
\label{sec:orgba1cd62}

\begin{frame}[label={sec:org99cb34c}]{Artificial censoring at the prediction horizon}
...
\begin{frame}[label={sec:org8ae3ddf}]{Non-proportional hazards data}
\begin{center}
\includegraphics[width=1\textwidth]{non_prop_hazard_plot.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgd08f76c}]{Simulation study}
\begin{center}
\includegraphics[width=1\textwidth]{sim_study_t4.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org4a1e90a}]{Simulation study}
\begin{center}
\includegraphics[width=1\textwidth]{sim_study_t6.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org91b93d4}]{Simulation study}
\begin{center}
...
\label{sec:orgbaea29d}

\begin{frame}[label={sec:orge6bc0a4}]{Discussion}
\begin{itemize}
