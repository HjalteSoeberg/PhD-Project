...
\label{sec:org13ddabd}

\begin{frame}[label={sec:org37f7624},fragile]{Competing risks risk prediction}
\begin{align*}
...
\begin{frame}[label={sec:orgc7bc6fc}]{Motivation}
...
\begin{frame}[label={sec:org6e79782}]{Setting: competing risks}
...
\begin{frame}[label={sec:orgf254548}]{The idea: fit both risks to the prediction horizon}
...
\label{sec:orgac6ec90}

\begin{frame}[label={sec:orgd1e0f38}]{Focus of this talk: a single model, not prediction strategy}
\begin{center}
...
\begin{frame}[label={sec:org145c57b}]{The Cox-exponential model}
...
\begin{frame}[label={sec:org1a51b07}]{Brier score estimation}
...
\begin{frame}[label={sec:orgf5fa428}]{Why estimate like this?}
...
\label{sec:org6e198ba}

\begin{frame}[label={sec:org0cad840}]{Artificial censoring at the prediction horizon}
...
\begin{frame}[label={sec:orgda57e78}]{Non-proportional hazards data}
\begin{center}
\includegraphics[width=1\textwidth]{non_prop_hazard_plot.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga87d4c5}]{Simulation study}
\begin{center}
...
\label{sec:orgca0582e}

\begin{frame}[label={sec:orgd75d5eb}]{Discussion}
\begin{itemize}
